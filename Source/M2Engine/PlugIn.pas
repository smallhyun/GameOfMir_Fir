...
//=============================================================================
    ...
    procedure HookProcessHumans(Value: PAnsiChar; Len: Integer); override;

    procedure GetDeCodeString(Buffer: PAnsiChar; var Len: Integer); override;
    procedure GetChangeCaptionText(Buffer: PAnsiChar; var Len: Integer); override;
    procedure GetChangeGateSocket(Buffer: PAnsiChar; var Len: Integer); override;
    procedure GetIPLocal(Buffer: PAnsiChar; var Len: Integer); override;
    procedure GetGetMaxPlayObjectCount(Buffer: PAnsiChar; var Len: Integer); override;
    procedure GetSetMaxPlayObjectCount(Buffer: PAnsiChar; var Len: Integer); override;
...
procedure MainMessage(Msg: PAnsiChar; nMsgLen: Integer; nMode: Integer); stdcall;
procedure SendBroadCastMsg(Msg: PAnsiChar; MsgType: TMsgType); stdcall;
function FindEngnProc(ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Pointer; stdcall;
function FindPlugProc(ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Pointer; stdcall;
function SetProcTable(ProcAddr: Pointer; ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Boolean; stdcall;
function FindOBjTable(ObjName: PAnsiChar; nNameLen: Integer; nObjcCode: Integer): TObject; stdcall;

implementation

uses svMain, PlugOfEngine, M2Share, EncryptUnit, Common;

procedure MainMessage(Msg: PAnsiChar; nMsgLen: Integer; nMode: Integer);
var
  MsgBuff: AnsiString;
begin
...
function FindPlugProc(ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Pointer;
var
  I: Integer;
...
function FindEngnProc(ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Pointer;
var
  I: Integer;
  sProcName: AnsiString;
begin
...
function SetProcTable(ProcAddr: Pointer; ProcName: PAnsiChar; nNameLen: Integer; nProcCode: Integer): Boolean;
var
  I: Integer;
  sProcName: AnsiString;
begin
...
function FindOBjTable(ObjName: PAnsiChar; nNameLen: Integer; nObjcCode: Integer): TObject;
var
  I: Integer;
  sObjName: AnsiString;
begin
...
procedure TPlugInManage.HookProcessHumans(Value: PAnsiChar; Len: Integer);
var
  sBuffer: AnsiString;
begin
...
procedure TPlugInManage.GetDeCodeString(Buffer: PAnsiChar; var Len: Integer);
var
...
procedure TPlugInManage.GetIPLocal(Buffer: PAnsiChar; var Len: Integer);
var
  nIPLocal: Integer;
  sBuffer: string;
begin
...
procedure TPlugInManage.GetChangeCaptionText(Buffer: PAnsiChar; var Len: Integer);
var
...
procedure TPlugInManage.GetChangeGateSocket(Buffer: PAnsiChar; var Len: Integer);
var
...
procedure TPlugInManage.GetGetMaxPlayObjectCount(Buffer: PAnsiChar; var Len: Integer);
var
...
procedure TPlugInManage.GetSetMaxPlayObjectCount(Buffer: PAnsiChar; var Len: Integer);
var
...
begin
  ...
  if not DirectoryExists(g_Config.sPlugDir) then begin
    //CreateDirectory(PAnsiChar(g_Config.sConLogDir),nil);
