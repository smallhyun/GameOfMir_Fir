...
type
  TfrmItemSet = class(TForm)
    ...
    Label213: TLabel;
    EditRobotRandomAddValue: TSpinEdit;
    Label215: TLabel;
    EditRobotRandomNewAddValue: TSpinEdit;
    Label216: TLabel;
    EditRobotRandomNotLimit: TSpinEdit;
    Label217: TLabel;
    EditRobotRandomAddPoint: TSpinEdit;
    ...
    procedure EditRobotRandomAddValueChange(Sender: TObject);
    procedure EditRobotRandomNewAddValueChange(Sender: TObject);
    procedure EditRobotRandomNotLimitChange(Sender: TObject);
    procedure EditRobotRandomAddPointChange(Sender: TObject);
  private
    boOpened: Boolean;
    boModValued: Boolean;
    procedure ModValue();
...
begin
  ...
  EditRobotRandomAddValue.Value := g_Config.nRobotRandomAddValue;
  ...
  EditRobotRandomNewAddValue.Value := g_Config.nRobotRandomNewAddValue;
  ...
  EditRobotRandomNotLimit.Value := g_Config.nRobotRandomNotLimit;
  ...
  EditRobotRandomAddPoint.Value := g_Config.nRobotRandomAddPoint;
...
begin
  ...
  Config.WriteInteger('Setup', 'RobotRandomAddValue', g_Config.nRobotRandomAddValue);
...
begin
  ...
  Config.WriteInteger('Setup', 'RobotRandomNewAddValue', g_Config.nRobotRandomNewAddValue);
...
begin
  ...
  Config.WriteInteger('Setup', 'RobotRandomNotLimit', g_Config.nRobotRandomNotLimit);
...
begin
  ...
  Config.WriteInteger('Setup', 'RobotRandomAddPoint', g_Config.nRobotRandomAddPoint);
...
procedure TfrmItemSet.EditRobotRandomAddValueChange(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.nRobotRandomAddValue := EditRobotRandomAddValue.Value;
  ModValue();
end;

procedure TfrmItemSet.EditRobotRandomNewAddValueChange(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.nRobotRandomAddValue := EditRobotRandomAddValue.Value;
  ModValue();
...
procedure TfrmItemSet.EditRobotRandomNotLimitChange(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.nRobotRandomNotLimit := EditRobotRandomNotLimit.Value;
  ModValue();
end;

procedure TfrmItemSet.EditRobotRandomAddPointChange(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.nRobotRandomAddPoint := EditRobotRandomAddPoint.Value;
  ModValue();
end;
