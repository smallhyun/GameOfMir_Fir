...
type
  ...
  TfrmHeroConfig = class(TForm)
    ...
    Label9: TLabel;
    Label16: TLabel;
    CheckBoxHeroMag64DownHealth: TCheckBox;
    ...
    procedure CheckBoxHeroMag64DownHealthClick(Sender: TObject);
  private
...
begin
  ...
  CheckBoxHeroMag64DownHealth.Checked := g_Config.boHeroMag64DownHealth;
  boOpened := True;
  ShowModal;
end;
...
begin
  ...
  Config.WriteBool('HeroSetup', 'HeroMag64DownHealth', g_Config.boHeroMag64DownHealth);
  uModValue();
end;
...
procedure TfrmHeroConfig.CheckBoxHeroMag64DownHealthClick(Sender: TObject);
begin
  if not boOpened then Exit;
  g_Config.boHeroMag64DownHealth := CheckBoxHeroMag64DownHealth.Checked;
  ModValue();
end;
