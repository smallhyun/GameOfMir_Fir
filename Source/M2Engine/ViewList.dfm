object frmViewList: TfrmViewList
  ...
  object PageControlViewList: TPageControl
    ...
    object TabSheet18: TTabSheet
      Caption = #20801#35768#20154#29289#25441#21462#29289#21697
      ImageIndex = 18
      object GroupBox30: TGroupBox
        ...
        Width = 177
        Height = 365
        Caption = #20154#29289#20801#35768#25441#21462#29289#21697#21015#34920
        TabOrder = 0
        object ListBoxAllowHumPickUpItem: TListBox
          Left = 8
          Top = 16
          Width = 161
          Height = 337
          Hint = #20801#35768#20154#29289#25441#21462#29289#21697#35774#32622#65292#21152#20837#27492#21015#34920#30340#29289#21697#20154#29289#25165#20250#25441#21462
          ItemHeight = 12
          TabOrder = 0
          OnClick = ListBoxAllowHumPickUpItemClick
        end
      end
      ...
      object ButtonPickUpHumAdd: TButton
        Left = 200
        Top = 24
        Width = 73
        Height = 25
        Caption = #22686#21152'(&A)'
        TabOrder = 2
        OnClick = ButtonPickUpHumAddClick
      end
      object ButtonPickUpHumDel: TButton
        Left = 200
        Top = 56
        Width = 73
        Height = 25
        Caption = #21024#38500'(&D)'
        TabOrder = 3
        OnClick = ButtonPickUpHumDelClick
      end
      object ButtonPickUpHumAddAll: TButton
        Left = 200
        Top = 88
        Width = 73
        Height = 25
        Caption = #20840#37096#22686#21152'(&A)'
        TabOrder = 4
        OnClick = ButtonPickUpHumAddAllClick
      end
      object ButtonPickUpHumDelAll: TButton
        Left = 200
        Top = 120
        Width = 73
        Height = 25
        Caption = #20840#37096#21024#38500'(&D)'
        TabOrder = 5
        OnClick = ButtonPickUpHumDelAllClick
      end
      object ButtonPickUpHumSave: TButton
        Left = 200
        Top = 152
        Width = 73
        Height = 25
        Caption = #20445#23384'(&S)'
        TabOrder = 6
        OnClick = ButtonPickUpHumSaveClick
      end
    end
  end
end
