...
type
  ...
  TfrmGameConfig = class(TForm)
    ...
    Label161: TLabel;
    Label162: TLabel;
    EditHitCountIntervalTime: TSpinEdit;
    EditCanHitCount: TSpinEdit;
    EditMagicHitCountIntervalTime: TSpinEdit;
    EditCanMagicHitCount: TSpinEdit;
    EditMoveCountIntervalTime: TSpinEdit;
    EditCanMoveCount: TSpinEdit;
    EditCheckHitCount: TSpinEdit;
    EditCheckMagicHitCount: TSpinEdit;
    EditCheckMoveCount: TSpinEdit;
    Label159: TLabel;
...
procedure TfrmGameConfig.EditMagicHitCountIntervalTimeChange(
  Sender: TObject);
begin
  if not boOpened then Exit;
