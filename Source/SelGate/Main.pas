...
uses
  ...
  Dialogs, D7ScktComp, ExtCtrls, StdCtrls, Common, EncryptUnit, Grobal2,
  ComCtrls, RzListVw, ImgList, RzButton, Menus, RzPanel, RzStatus, HUtil32,
  GateShare, Share, Mudutil, Clipbrd, IniFiles, System.ImageList;
