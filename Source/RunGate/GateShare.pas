...
interface
uses
  Windows, Messages, SysUtils, Classes, D7ScktComp, WinSock, SyncObjs, IniFiles, Grobal2, Common;
resourcestring
  g_sVersion = '程序版本: 1.00 Build 20120715';
...
var
  ...
  g_sClientPassWord: string = '123456';
implementation
