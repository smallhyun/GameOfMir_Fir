...
{$IFEND}
  ...
  TObjectOperateMessage = function(BaseObject: TObject;
    ...
    pszMsg: PAnsiChar; var boReturn: Boolean): Boolean; stdcall;
  ...
  public
    ...
    procedure HookProcessHumans(Value: PAnsiChar; Len: Integer); virtual; abstract;


    procedure GetDeCodeString(Buffer: PAnsiChar; var Len: Integer); virtual; abstract;
    procedure GetChangeCaptionText(Buffer: PAnsiChar; var Len: Integer); virtual; abstract;
    procedure GetChangeGateSocket(Buffer: PAnsiChar; var Len: Integer); virtual; abstract;
    procedure GetIPLocal(Buffer: PAnsiChar; var Len: Integer); virtual; abstract;
    procedure GetGetMaxPlayObjectCount(Buffer: PAnsiChar; var Len: Integer); virtual; abstract;
    procedure GetSetMaxPlayObjectCount(Buffer: PAnsiChar; var Len: Integer); virtual; abstract;
...
procedure ShortStringToPAnsiChar(S: PTShortString; pszDest: PAnsiChar);
implementation
...
begin
  EngineOut.TPlayObject_SendSocket(BaseObject, DefMsg, PAnsiChar(sMsg));
end;

procedure TCharObject.SendDefMessage(wIdent: Word; nRecog: Integer; nParam, nTag, nSeries: Word; sMsg: string);
begin
  EngineOut.TPlayObject_SendDefMessage(BaseObject, wIdent, nRecog, nParam, nTag, nSeries, PAnsiChar(sMsg));
end;
...
begin
  ...
  if ShortString <> nil then begin
    ...
    ShortStringToPAnsiChar(ShortString, @sGameGoldName[1]);
...
begin
  ...
  if ShortString <> nil then begin
    ...
    ShortStringToPAnsiChar(ShortString, @sCharName[1]);
    Result := sCharName;
  end;
end;
...
begin
  ...
  if ShortString <> nil then begin
    ...
    ShortStringToPAnsiChar(ShortString, @sMapName[1]);
    Result := sMapName;
  end;
end;
...
begin
  EngineOut.TNormNpc_GotoLable(BaseObject, PlayObject, PAnsiChar(sLabel));
end;
...
begin
  EngineOut.TPlayObject_SetUserInPutString(BaseObject, PAnsiChar(Value));
end;
...
begin
  EngineOut.TActorObject_SendMsg(BaseObject, AObject, wIdent, wParam, nParam1, nParam2, nParam3, PAnsiChar(pszMsg));
end;

procedure TCharObject.SendRefMsg(wIdent, wParam: Word; nParam1, nParam2, nParam3: Integer; pszMsg: string);
begin
  EngineOut.TActorObject_SendRefMsg(BaseObject, wIdent, wParam, nParam1, nParam2, nParam3, PAnsiChar(pszMsg));
end;
...
begin
  EngineOut.TActorObject_SendDelayMsg(BaseObject, AObject, wIdent, wParam, nParam1, nParam2, nParam3, PAnsiChar(pszMsg), dwDelayTime);
end;

procedure TCharObject.SysMsg(sMsg: string; MsgColor: TMsgColor; MsgType: TMsgType);
begin
  EngineOut.TActorObject_SysMsg(BaseObject, PAnsiChar(sMsg), MsgColor, MsgType);
end;
...
begin
  Result := EngineOut.TUserEngine_GetStdItemByName(PAnsiChar(sName));
end;

function TUserManage.GetPlayObject(sPlayName: string): TPlayObject;
begin
  Result := EngineOut.TUserEngine_GetPlayObject(PAnsiChar(sPlayName), True);
end;

function TUserManage.CopyToUserItemFromName(const sItemName: string; UserItem: pTUserItem): BOOL;
begin
  Result := EngineOut.TUserEngine_CopyToUserItemFromName(PAnsiChar(sItemName), UserItem);
end;
