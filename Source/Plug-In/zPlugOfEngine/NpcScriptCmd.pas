...
function ScriptActionCmd(pszCmd: PAnsiChar): Integer; stdcall;
function ScriptConditionCmd(pszCmd: PAnsiChar): Integer; stdcall;
procedure CheckUserSelect(Merchant: TMerchant; AObject: TPlayObject; pszLabel, pszData: PAnsiChar); stdcall;


procedure ScriptAction(Npc: TObject; PlayObject: TObject; nCmdCode: Integer;
  pszParam1: PAnsiChar; nParam1: Integer; pszParam2: PAnsiChar; nParam2: Integer;
  pszParam3: PAnsiChar; nParam3: Integer; pszParam4: PAnsiChar; nParam4: Integer;
  pszParam5: PAnsiChar; nParam5: Integer; pszParam6: PAnsiChar; nParam6: Integer;
  pszParam7: PAnsiChar; nParam7: Integer; pszParam8: PAnsiChar; nParam8: Integer;
  pszParam9: PAnsiChar; nParam9: Integer; pszParam10: PAnsiChar; nParam10: Integer); stdcall;
...
function ScriptCondition(Npc: TObject; PlayObject: TObject; nCmdCode: Integer;
  ...
  pszParam5: PAnsiChar; nParam5: Integer; pszParam6: PAnsiChar; nParam6: Integer;
  pszParam7: PAnsiChar; nParam7: Integer; pszParam8: PAnsiChar; nParam8: Integer;
  pszParam9: PAnsiChar; nParam9: Integer; pszParam10: PAnsiChar; nParam10: Integer): Boolean; stdcall;

function ConditionOfCheckOnlinePlayCount(Npc: TObject; pszParam1: PAnsiChar; nCount: Integer): Boolean;
function ConditionOfCheckPlaylvl(AObject: TObject; pszParam1: PAnsiChar; nParam1: Integer): Boolean;
function ConditionOfCheckPlaySex(AObject: TObject; pszParam1: PAnsiChar): Boolean;
function ConditionOfCheckPlayJob(AObject: TObject; pszParam1: PAnsiChar): Boolean;
function ConditionOfCheckPlayMapGuildCount(AObject: TObject; pszParam1: PAnsiChar; nParam2: Integer): Boolean;
var
...
procedure CheckUserSelect(Merchant: TMerchant; AObject: TPlayObject; pszLabel, pszData: PAnsiChar);
var
  sLabel, sData: string;
  nData: Integer;
  nLength: Integer;
...
procedure ActionOfGiveUserItem(Npc: TObject; PlayObject: TObject; pszItemName: PAnsiChar; nCount: Integer);
begin

end;

procedure ActionOfTakeUserItem(Npc: TObject; PlayObject: TObject; pszItemName: PAnsiChar; nCount: Integer);
begin
