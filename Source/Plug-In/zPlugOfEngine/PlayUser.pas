...
function FilterMsg(PlayObject: TObject; pszSrcMsg, pszDestMsg: PAnsiChar; var boGotoLabel: Boolean): Boolean; stdcall;

function CheckCanDropItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
function CheckCanDealItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
function CheckCanStorageItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
function CheckCanRepairItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;

function CheckCanUpgradeItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
function CheckCanSellItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
function CheckCanNotScatterItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
function CheckCanDieScatterItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean; stdcall;
...
function CheckCanUpgradeItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean;
resourcestring
  sMsg = '此物品禁止升级！！！';
var
  I: Integer;
...
function CheckCanSellItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean;
resourcestring
  sMsg = '此物品禁止出售！！！';
var
  I: Integer;
...
function CheckCanNotScatterItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean;
//resourcestring
 // sMsg = '此物品禁止爆出！！！';
var
  I: Integer;
...
function CheckCanDieScatterItem(PlayObject: TPlayObject; pszItemName: PAnsiChar; boHintMsg: Boolean): Boolean;
{resourcestring
  sMsg = '此物品禁止爆出！！！';  }
var
  I: Integer;
...
function FilterMsg(PlayObject: TObject; pszSrcMsg, pszDestMsg: PAnsiChar; var boGotoLabel: Boolean): Boolean;
var
  sSrcMsg: string;
  nDestLen: Integer;
begin
