...
interface
uses
  Windows, Messages, Classes, SysUtils, D7ScktComp, IniFiles, Controls, Grobal2, Common, HumDB, MudUtil, SDK;
resourcestring
  g_sVersion = '程序版本: 1.00 Build 20120915';
  g_sUpDateTime = '更新日期: 2012/09/15';
