    ...
    if Open then begin
      ...
      if FileRead(m_nFileHandle, DBHeader, SizeOf(TDBHeader)) = SizeOf(TDBHeader) then begin
        ...
        for nIndex := 0 to DBHeader.nHumCount - 1 do begin
          ...
          //if DBRecord.sChrName = 'xiaohao' then
         //   MainOutMessage(Format('sAccount:%s sChrName:%s boIsHero:%s boDeleted:%s',
         //     [DBRecord.sAccount, DBRecord.sChrName, BoolToStr(DBRecord.Header.boIsHero), BoolToStr(DBRecord.Header.boDeleted)]));
          ...
          if not DBRecord.Header.boDeleted then begin
            ...
            //MainOutMessage('LoadQuickList:'+DBRecord.Header.sName);
        ...
        for nIndex := 0 to DBHeader.nHumCount - 1 do begin
         ...
         {if Pos('传说',RecordHeader.sName)>0 then begin    //
          ...
          if not RecordHeader.boDeleted then begin
            //MainOutMessage('TFileDB.LoadQuickList:'+RecordHeader.sName);
