...
uses
  ...
  Dialogs, D7ScktComp, ExtCtrls, StdCtrls, Menus, Grids, WinSock, Common;
...
{$ELSE}
    ...
    procedure SelectSocketGetSocket(Sender: TObject; Socket: TSocket; var ClientSocket: TServerClientWinSocket);
...
procedure TFrmMain.ServerSocketGetSocket(Sender: TObject; Socket: TSocket; var ClientSocket: TServerClientWinSocket);
begin
...
procedure TFrmMain.SelectSocketGetSocket(Sender: TObject; Socket: TSocket; var ClientSocket: TServerClientWinSocket);
begin
