...
const
    FtpSrvT_Unit       = 112;
    CopyRight : String = ' FtpSrvT  (c) 1999-2006 F. Piette V1.12 ';
...
function MySeek64 (Source: TStream; const Offset: Int64; Origin: Integer): Int64;
{$ENDIF}
...
{* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
{ TFileStream.Seek replacement that forces 64 bits } 
function MySeek64 (Source: TStream; const Offset: Int64; Origin: Integer): Int64;
begin
  Result := Offset;
  Int64Rec(Result).Lo := SetFilePointer (THandle(THandleStream(Source).Handle),
                             Int64Rec(Result).Lo, @Int64Rec(Result).Hi, Origin);
end ;
