...
uses
  ...
  Forms, StdCtrls, IniFiles, ExtCtrls,
  OverbyteIcsWinSock, OverbyteIcsWSocket,
  OverbyteIcsFtpCli,  OverbyteIcsWndControl;

const
  OverbyteIcsFtpTstVersion = 225;
  CopyRight : String = 'OverbyteIcsFtpTst (c) 1997-2006 Francois Piette  V2.25 ';
