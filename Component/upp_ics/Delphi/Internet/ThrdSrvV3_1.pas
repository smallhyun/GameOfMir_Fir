...
uses
  ...
  Dialogs, IniFiles, StdCtrls, ExtCtrls, WSocket, WSocketS, WSocketTS;

const
  TcpSrvVersion  = 300;
  CopyRight      = ' TcpSrv (c) 2005-2006 by François PIETTE. V3.00';
...
begin
    ...
    while (Length(Cli.RcvdLine) > 0) and
              (Cli.RcvdLine[Length(Cli.RcvdLine)] in [#13, #10]) do
