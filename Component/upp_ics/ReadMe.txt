...
Legal issues: 
-------------
              Copyright (C) 1997-2006 by François PIETTE 
...
.\cpp\internet\bds2006        C++Builder 2006 projects
...
doesn't exist because project group was introduced with Delphi 4. Open each
...
many components in many different subdirectories, you'll get strange errors. 
...
Using Delphi 3 Pro, there could a problem after inserting all the components
...
3)	Put all of these new files in a directory separate from your components.
...
11)	Now you can safely add TnEmulVT.pas to your User Package and build
        it.
...
down and found out to trigger this error all one needs to do is go to:
