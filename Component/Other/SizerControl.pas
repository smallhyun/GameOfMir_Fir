  ...
  begin
    ...
    begin
      ...
      begin
       ...
       // offset := HalfGridSize mod GridSize;
        offsetA := (left - formOffset.x) mod GridSize;
        if offsetA < HalfGridSize then
          dec(left, offsetA) else inc(left, GridSize - offsetA);
        offsetA := (top - formOffset.y) mod GridSize;
        if offsetA < HalfGridSize then
          dec(top, offsetA) else inc(top, GridSize - offsetA);
        offsetA := (right - formOffset.x) mod GridSize;
        if offsetA < HalfGridSize then
          dec(right, offsetA) else inc(right, GridSize - offsetA);
        offsetA := (bottom - formOffset.y) mod GridSize;
        if offsetA < HalfGridSize then
          dec(bottom, offsetA) else inc(bottom, GridSize - offsetA);
      end;
